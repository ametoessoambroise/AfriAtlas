        ...
        <div className="lg:grid lg:grid-cols-3 gap-4 flex flex-col w-full lg:py-10 pt-6 pb-4 lg:px-10 px-4">
          <div className="md:flex lg:flex-col lg:space-y-4 h-full lg:gap-0 gap-4">
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className="lg:flex-[7] flex-[6] flex flex-col justify-between relative bg-primary/10 overflow-hidden rounded-2xl border border-primary/20 p-6 md:p-8 shadow-sm"
            >
              ...
              <article className="mt-auto relative z-10">
                ...
                <p className="text-lg font-medium leading-relaxed mb-8">
                  "WorldAtlas Travel a été une découverte incroyable. Leur
            ...
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className="lg:flex-[3] flex-[4] lg:h-fit lg:shrink-0 flex flex-col justify-between relative bg-primary text-primary-foreground overflow-hidden rounded-2xl border border-primary/20 p-6 md:p-8 shadow-md"
            >
              <article className="mt-auto relative z-10">
                <Quote className="w-6 h-6 text-white/30 mb-3" />
                <p className="text-primary-foreground/90 font-medium mb-6">
                  "Notre séjour au Togo a été magique grâce à WorldAtlas. Une
          ...
          <div className="lg:h-full md:flex lg:flex-col h-fit lg:space-y-4 lg:gap-0 gap-4">
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className="flex flex-col justify-between relative bg-card text-card-foreground overflow-hidden rounded-2xl border border-border p-6 md:p-8 shadow-sm"
            >
              <article className="mt-auto relative z-10">
            ...
            >
              <article className="mt-auto relative z-10">
                <p className="2xl:text-base text-sm mb-6">
                  "Extrêmement satisfaits des services de WorldAtlas.
          ...
          <div className="h-full md:flex lg:flex-col lg:space-y-4 lg:gap-0 gap-4">
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className="lg:flex-[3] flex-[4] flex flex-col justify-between relative bg-secondary text-secondary-foreground overflow-hidden rounded-2xl border border-border p-6 md:p-8 shadow-sm"
            >
              <article className="mt-auto relative z-10">
                <Quote className="w-6 h-6 text-foreground/20 mb-3" />
                <p className="mb-6 font-medium">
                  "WorldAtlas a été le partenaire idéal pour notre voyage de
            ...
            <TimelineContent
              ...
              customVariants={revealVariants}
              timelineRef={testimonialRef}
              className="lg:flex-[7] flex-[6] flex flex-col justify-between relative bg-primary/5 overflow-hidden rounded-2xl border border-primary/20 p-6 md:p-8 shadow-sm"
            >
              <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:50px_56px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)] opacity-30"></div>
              <article className="mt-auto relative z-10">
                <Quote className="w-8 h-8 text-primary/40 mb-4" />
                <p className="text-lg font-medium leading-relaxed mb-8">
                  "WorldAtlas a radicalement changé notre vision du Togo. Leur
