...
export function VrBookingSidebar({
  ...
  return (
    <div className="lg:col-span-4 space-y-5">
      {/* ── Hero card ── */}
      <div className="relative rounded-md overflow-hidden aspect-[4/3] border border-border">
        <img
          src="/dark-blue.png"
          alt="Casque VR"
      ...
      {/* ── Aide ── */}
      <div className="rounded-md border border-border bg-muted/20 p-5 space-y-4">
        ...
        <div className="space-y-3">
          ...
          <a
            href="mailto:support@Afriatlas.com"
            className="flex items-center gap-3 text-sm text-foreground hover:text-primary transition-colors"
          >
            <div className="h-8 w-8 rounded-md bg-muted flex items-center justify-center flex-shrink-0">
              <Mail className="h-3.5 w-3.5 text-muted-foreground" />
            </div>
            support@Afriatlas.com
          </a>
        </div>
      </div>
