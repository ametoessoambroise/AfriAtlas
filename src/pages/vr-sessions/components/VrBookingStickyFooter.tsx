...
export function VrBookingStickyFooter({
  ...
  return (
    <div className="rounded-md border border-border bg-background p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
      <div>
      ...
      <button
        onClick={onSubmit}
        disabled={isBooking}
        className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-md px-8 py-3.5 transition-all active:scale-[0.98] disabled:opacity-60"
      >
        {isBooking ? (
