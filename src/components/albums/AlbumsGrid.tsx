    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[...Array(6)].map((_, i) => (
          <div
            key={i}
            className="rounded-[2.5rem] overflow-hidden bg-background h-[400px]"
          >
        ...
        >
          ...
          {viewMode === "grid" && (
            ...
            >
              <Link
                to="/albums/new"
                className="flex flex-col items-center justify-center h-full min-h-[300px] rounded-[2.5rem] border-2 border-dashed border-border hover:border-primary/50 hover:bg-primary/5 transition-all group bg-background/50"
              >
