      ...
      <div className="flex flex-col lg:flex-row">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="rounded-xl h-10 px-5 font-medium bg-primary hover:bg-primary/90 text-primary-foreground gap-2"
                >
                  {isGenerating
                ...
                {story && !isGenerating && (
                  <Button
                    ...
                    className="h-10 w-10 rounded-xl text-muted-foreground hover:text-destructive hover:border-destructive/30"
                  >
          ...
          <AnimatePresence>
            {(story || isGenerating) && (
              <motion.div
                ...
                className="overflow-hidden"
              >
                <div className="rounded-xl border border-border bg-muted/20 p-4 max-h-[200px] overflow-y-auto">
        ...
        <div className="flex-1 border-t lg:border-t-0 lg:border-l border-border bg-muted/10 p-5">
          <div className="grid grid-cols-3 grid-rows-4 gap-2.5 h-full min-h-[380px]">
            ...
            <div className="col-span-2 row-span-2 relative rounded-xl overflow-hidden border border-border group cursor-pointer">
              <img
            ...
            {/* Tile 2 — Musique */}
            <div className="col-span-1 row-span-1 rounded-xl border border-secondary/20 bg-secondary/10 p-3.5 flex flex-col justify-between">
            ...
            {/* Tile 3 — Scènes */}
            <div className="col-span-1 row-span-1 rounded-xl border border-primary/20 bg-primary/5 p-3.5 flex flex-col justify-between">
            ...
            <div className="col-span-1 row-span-2 relative rounded-xl overflow-hidden border border-border group cursor-pointer">
              <img
            ...
            {/* Tile 5 — IA narrative */}
            <div className="col-span-1 row-span-1 rounded-xl border border-border bg-muted/30 p-3.5 flex flex-col justify-between">
            ...
            <div className="col-span-1 row-span-1 relative rounded-xl overflow-hidden border border-border group cursor-pointer">
              <img
            ...
            {/* Tile 7 — Reel large */}
            <div className="col-span-2 row-span-1 relative rounded-xl overflow-hidden border border-border group cursor-pointer">
              <img
