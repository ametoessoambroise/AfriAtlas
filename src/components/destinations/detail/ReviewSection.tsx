    ...
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <Button
          ...
          className="rounded-2xl font-bold bg-primary px-8 py-6 h-auto shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all"
        >
          {showForm ? (
      ...
      <div className="grid gap-12 lg:grid-cols-3">
        ...
        <div className="lg:col-span-1 space-y-8">
          <div className="rounded-[2.5rem] border border-border bg-surface-alt p-8 space-y-6">
          ...
          <div className="">
            <img src="/joystick.png" alt="casque" className="w-full h-full object-cover rounded-2xl" />
          </div>
        </div>
          ...
          <AnimatePresence>
            {showForm && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className="p-8 rounded-[2rem] border-2 border-dashed border-primary/20 bg-primary/5 mb-10"
              >
          ...
          <div className="space-y-6">
            {hardcodedReviews.map((review, i) => (
              <motion.div
                ...
                className="p-8 rounded-[2.5rem] border border-border bg-card shadow-sm hover:shadow-md transition-shadow space-y-6"
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-4">
                    <div className="h-14 w-14 rounded-2xl overflow-hidden bg-muted border border-border">
                      <img
