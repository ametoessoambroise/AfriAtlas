      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col xl:flex-row gap-6 items-start">
            ...
            {/* Image de casque vr */}
            {/* <div className="w-full xl:w-64 shrink-0 rounded-2xl border border-border bg-background p-2">
              <img
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select onValueChange={field.onChange} value={field.value}>
                    <SelectTrigger className="h-11 rounded-xl border-border bg-muted/20 text-foreground">
