  ...
  return (
    <div className="mt-20 grid gap-6 lg:grid-cols-2">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-md bg-primary p-10 text-foreground shadow-2xl group cursor-pointer"
      >
        ...
        <div className="relative z-10 space-y-6 max-w-sm">
          ...
          <button className="flex items-center gap-3 bg-background text-foreground px-8 py-4 rounded-md font-bold transition-all hover:bg-background/80 active:scale-95 shadow-lg">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-md bg-[#f8fafc] border border-slate-200 p-10 text-slate-900 shadow-xl group cursor-pointer"
      >
        ...
        <div className="relative z-10 space-y-6 max-w-sm">
          ...
          <button
            ...
            className="flex items-center gap-3 bg-primary text-white px-8 py-4 rounded-md font-bold transition-all hover:bg-primary/80 active:scale-95 shadow-lg shadow-primary/20"
          >
