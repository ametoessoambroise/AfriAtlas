    ...
    <>
      ...
      >
        <div
          ...
          } w-full rounded-3xl overflow-hidden border border-border bg-card shadow-sm hover:shadow-lg transition-shadow duration-300`}
        >
          {/* ── Panneau Image ── */}
          <div
            className={`relative ${
          ...
          >
            ...
            <div className="absolute top-4 right-4 z-20 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              ...
              <EditImageCaptionDialog
                ...
                trigger={
                  <button
                    className="w-10 h-10 rounded-full bg-muted/95 hover:bg-muted shadow-lg flex items-center justify-center transition-all duration-200 active:scale-95"
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      définitivement supprimée de votre album.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            >
              <div
                className={`relative w-full overflow-hidden transform max-w-full aspect-[3/4] hover:scale-105 transition-transform duration-500`}
              >
                <LazyImage
                  src={imageUrl}
          ...
          <div className="flex-1 flex flex-col justify-between p-6 sm:p-8 gap-5">
            ...
            <div className="space-y-4">
              {/* Catégorie */}
              <div className="inline-flex items-center gap-2 bg-background text-primary text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full">
              ...
              {/* Titre */}
              <h2
                className="text-[1.85rem] sm:text-[2.1rem] font-black text-primary leading-[1.1] tracking-tight line-clamp-2"
              ...
              {/* Description */}
              {image.caption && (
                <p className="text-sm text-muted-foreground leading-relaxed max-w-sm line-clamp-3">
                  {image.caption}
                </p>
              )}
            ...
            {tags.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {tags.slice(0, 3).map((tag) => (
                  <span
                    key={tag}
                    className="px-4 py-1.5 rounded-full border border-border bg-background text-foreground text-xs font-medium"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="inline-flex items-center gap-2.5 bg-primary hover:bg-primary/80 active:scale-[0.98] text-white font-semibold text-sm px-6 py-3 rounded-2xl transition-all duration-200 shadow-md shadow-primary/20"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 border border-border hover:border-primary hover:bg-primary/20 active:scale-[0.98] text-primary font-semibold text-sm px-5 py-3 rounded-2xl transition-all duration-200"
              >
