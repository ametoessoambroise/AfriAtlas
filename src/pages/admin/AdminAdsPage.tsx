...
export default function AdminAdsPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col sm:flex-row gap-4 bg-white/5 p-4 rounded-[2rem] border border-white/5 backdrop-blur-xl">
        <div className="relative flex-1">
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-white/20" />
          <Input
            placeholder="Filtrer par annonceur ou lieu..."
            className="bg-black/20 border-white/5 pl-12 h-12 text-white text-sm focus-visible:ring-emerald-500/20 rounded-2xl"
          />
        </div>
        <div className="flex gap-2">
          <Button
            variant="outline"
            className="border-white/5 bg-white/5 text-white/60 hover:text-white h-12 px-6 rounded-2xl font-bold text-xs uppercase"
          >
            Active
          </Button>
          <Button
              ...
              >
                <TableCell className="pl-8">
                  <div className="flex items-center gap-4">
                    <div className="w-16 h-10 rounded-xl bg-white/5 border border-white/5 overflow-hidden flex-shrink-0">
                      {ad.image_url ? (
                        <img
                          src={ad.image_url}
                          alt=""
                  ...
                  <div className="flex items-center justify-end gap-2">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="ghost"
                          className="h-10 w-10 text-white/40 hover:text-white rounded-xl hover:bg-white/5 p-0"
                        >
                      ...
                      <DropdownMenuContent
                        align="end"
                        className="bg-zinc-900 border-white/10 text-white p-2 rounded-2xl w-48 shadow-2xl"
                      >
                        <DropdownMenuItem className="gap-3 py-2.5 rounded-xl focus:bg-white/5 cursor-pointer font-bold text-xs uppercase tracking-tighter">
                        ...
                        <DropdownMenuItem className="gap-3 py-2.5 rounded-xl focus:bg-red-400/10 focus:text-red-400 text-red-500 cursor-pointer font-bold text-xs uppercase tracking-tighter">
...
function MetricsCard({
  ...
  return (
    <Card className="bg-zinc-900/40 border-white/5 rounded-3xl p-6 backdrop-blur-xl">
...
function AdStatusToggle({ ad }: { ad: any }) {
  ...
  return (
    <button
      ...
      className={`h-10 px-4 rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all flex items-center gap-2 ${
        isActive
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-emerald-500 hover:bg-emerald-600 text-zinc-950 font-black rounded-2xl px-6 gap-2 h-12 italic uppercase tracking-tighter shadow-lg shadow-emerald-500/20">
          <Plus className="h-5 w-5" /> Nouvelle Campagne
        </Button>
      </DialogTrigger>
      <DialogContent className="bg-zinc-950 border-white/10 text-white p-0 rounded-[2.5rem] overflow-hidden max-w-lg">
        <DialogHeader className="p-8 pb-0">
          <DialogTitle className="text-3xl font-black italic uppercase tracking-tighter">
            Créer une Annonce
          </DialogTitle>
          <DialogDescription className="text-white/40 text-xs">
            Configurez votre placement Premium sur le réseau WorldAtlas Travel.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="p-6 border-2 border-dashed border-white/5 rounded-3xl flex flex-col items-center justify-center text-center gap-3 group hover:border-emerald-500/20 transition-all cursor-pointer">
            <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white/20 group-hover:text-emerald-500 transition-colors">
        ...
        <DialogFooter className="p-8 pt-0 flex gap-3">
          <Button
            variant="ghost"
            className="flex-1 rounded-2xl h-12 font-bold text-white/40 hover:text-white uppercase tracking-tighter"
          >
            Annuler
          </Button>
          <Button className="flex-1 rounded-2xl h-12 bg-emerald-500 hover:bg-emerald-600 text-zinc-950 font-black uppercase tracking-tighter">
            Lancer la Campagne
          </Button>
        </DialogFooter>
      </DialogContent>
