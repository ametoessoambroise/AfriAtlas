      ...
      <section className="relative pt-24 pb-16 min-h-[500px] flex flex-col justify-end">
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
          ...
          >
            ...
            <h1 className="text-[clamp(2.5rem,5vw+1rem,4rem)] font-heading font-semibold italic text-white mb-6 leading-[1.1]">
              Toutes les
              <br />
      ...
      <section className="py-20 bg-background">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h2 className="text-[clamp(2rem,4vw+1rem,3rem)] font-heading font-semibold italic text-foreground">
