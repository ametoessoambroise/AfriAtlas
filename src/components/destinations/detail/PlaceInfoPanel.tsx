  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {destination.address && (
          <div className="flex items-start gap-4 p-6 rounded-md border border-border bg-card shadow-sm group hover:shadow-md transition-all">
            <div className="bg-primary/10 p-3 rounded-md shrink-0 group-hover:scale-110 transition-transform">
              <MapPin className="h-6 w-6 text-primary" />
            </div>
            <div>
        ...
        {destination.website && (
          <div className="flex items-start gap-4 p-6 rounded-md border border-border bg-card shadow-sm group hover:shadow-md transition-all">
            <div className="bg-blue-500/10 p-3 rounded-md shrink-0 group-hover:scale-110 transition-transform">
