    ...
    <div className="relative overflow-hidden rounded-[2rem] bg-[#f0f5ff] border border-blue-100 p-8 md:p-12">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 space-y-6 max-w-xl">
          <Badge className="bg-[#1d4ed8] hover:bg-[#1e40af] text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest gap-1 border-none">
          ...
          <p className="text-[#475569] text-lg font-medium max-w-md">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-4">
            ...
            <Button
              variant="outline"
              className="bg-white/80 backdrop-blur-sm border-blue-200 text-[#1e293b] rounded-xl px-6 h-12 hover:bg-white font-bold"
            >
        ...
        <div className="relative w-full max-w-[300px] h-[300px] hidden md:block">
          ...
          <motion.div
            ...
            className="absolute top-10 left-0 w-40 h-48 bg-white p-2 rounded-lg shadow-xl shadow-slate-200 z-10 border border-slate-100"
          >
          ...
          <motion.div
            ...
            className="absolute top-0 right-0 w-44 h-56 bg-white p-2.5 rounded-lg shadow-2xl shadow-slate-300 z-20 border border-slate-100"
          >
            <div className="w-full h-full bg-slate-200 rounded overflow-hidden">
              <img
                src={heroImages[1]}
          ...
          <motion.div
            ...
            className="absolute bottom-0 left-10 w-48 h-40 bg-white p-2 rounded-lg shadow-xl shadow-slate-200 z-30 border border-slate-100"
          >
            <div className="w-full h-full bg-slate-200 rounded overflow-hidden">
              <img
                src={heroImages[2]}
